...
export const Card = ({
    ...
    return (
        <motion.div
            ...
            className="max-w-6xl -mt-12 mx-auto h-[35rem] md:h-[45rem] w-full border-2 border-zinc-700/50 p-2 md:p-6 bg-zinc-900/80 rounded-[30px] shadow-2xl backdrop-blur-sm"
        >
